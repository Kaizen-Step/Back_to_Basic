...
# Layout
st.set_page_config(page_title='NFT - Back to Basic: Active Users',
...
st.write(""" ### NFT Defenition """)

st.write(""" NFT stands for 'non-fungible token'. Non-fungible means that something is unique and can't be replaced. By contrast, physical money and cryptocurrencies are fungible, which means they can be traded or exchanged for one another.[[6]](https://www.kaspersky.com/resource-center/definitions/what-is-an-nft)      
